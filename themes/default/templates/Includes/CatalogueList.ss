<div class="list-media__item">
    <div class="list-media__poster--wrapper">
        <div
                ...
                style="background-image:url('$Poster.setHeight(350).Link'), url('/{$ThemeDir}/images/blank.png')"
        ></div>

        <div class="list-media__metadata">
            <h2 class="list-media__title"><a href="{$ParentTop.ProfileURL}title/{$ID}" class="list-media__title" title="Browse {$Title} (Updated {$LastEdited.Ago})">$Title</a></h2>
            ...
            >
                <button type="button" class="btn btn-default"><span class="fa fa-eye"></span> view more</button>
            </div>
