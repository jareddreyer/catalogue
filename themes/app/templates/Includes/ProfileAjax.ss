        ...
        <div class="video-details__container">
            <div class="video-details__metadata">
                ...
                <div class="video-details__utilities">
                    ...
                    <% end_if %>
                    <a href="{$Up.MaintenanceFormPageLink}edit/$ID" title="Edit {$Title}"><i class="fa fa-wrench"></i></a>
                                    ...
                                    <% loop $Up.relatedTitles %>
                                        <a href="{$Up.ProfileURL}title/$ID" title="Browse {$Title} (Updated {$LastEdited.Ago})">
                                            <div
                                                    ...
                                                    style="background-image:url('{$Poster.ScaleHeight(120).Link}'), url('{$ThemeDir}/images/blank.png')"
                                            ></div>
                                        </a>
                                    <% end_loop %>
                                </div>
                                    ...
                                    <% loop $Up.seeAlsoTitles %>
                                        <a href="{$Top.ProfileURL}title/$ID" title="Browse {$Title} (Updated {$LastEdited.Ago})">
                                            <div
                                                    ...
                                                    style="background-image:url('{$PosterID.ScaleHeight(120).Link}'), url('{$ThemeDir}/images/blank.png')"
                                            ></div>
                                        </a>
                                    <% end_loop %>
                                </div>
